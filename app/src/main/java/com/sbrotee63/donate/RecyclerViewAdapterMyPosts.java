...
public class RecyclerViewAdapterMyPosts extends RecyclerView.Adapter<RecyclerViewAdapterMyPosts.ViewHolder>{

    private static final String TAG = "RecyclerViewAdapterMyPosts";
    ...
    public RecyclerViewAdapterMyPosts(Context context, ArrayList<String> aBloodGroups, ArrayList<String> aLocations, ArrayList<String> aStatuses, ArrayList<String> apostId) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_my_posts, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            bloodGroup = itemView.findViewById(R.id.myposts_text_blood);
            location = itemView.findViewById(R.id.myposts_text_location);
            status = itemView.findViewById(R.id.myposts_text_status);

            parentLayout = itemView.findViewById(R.id.parent_layout_myposts);
        }
